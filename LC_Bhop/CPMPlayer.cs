...
namespace lcbhop
{
    ...
    public class CPMPlayer : MonoBehaviour
    {
        ...
        private void AirAccelerate(Vector3 wishdir, float wishspeed, float accel)
        {
            ...
            // Вместо жестких 75f используем динамическое ограничение.
            // Обычно в b長hop это 30.0f или около 1/3 от базовой скорости.
            // Если хотите полную свободу — закомментируйте следующую строку.
            ...
            // ИСПОЛЬЗУЕМ maxspeed ИЗ КОНФИГА ВМЕСТО 1500
        ...
        private void WalkMove()
        {
            ...
            if (wishJump)
            {
                velocity.y = jumpForce; // Используем значение из конфига вместо 295
            }
        }
